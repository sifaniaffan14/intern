    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <div class="pengajuanTop">
                ...
                <div class="bar">
                    <a href="" class="btn btn-dark btn-user">Belum Dikembalikan</a>
                    <a href="{{ route('sudahKembali')}}" class="btn btn-light btn-user">Sudah Dikembalikan</a>
                </div>
            </div>
                ...
                <div class="box1 card mb-4 py-3 border-left-primary">
                    <div class="itemPeminjaman">
                        ...
                        <div class="status">
                            ...
                            <div class="btn-tambah "><a href="{{ route('detailPengembalian', $item->id) }}"
